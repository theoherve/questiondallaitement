...
export const PERMISSIONS = {
  ...
  buy_accompagnement: "buy_accompagnement",
  manage_own_accompagnements: "manage_own_accompagnements",
  manage_own_accompagnements_readonly: "manage_own_accompagnements_readonly",
...
const ROLE_PERMISSIONS: Record<UserRole, Permission[]> = {
  ...
  client: [
    ...
    PERMISSIONS.buy_accompagnement,
  ],
  consultant: [
    PERMISSIONS.view_public_pages,
    PERMISSIONS.manage_own_accompagnements,
  ...
  consultant_limited: [
    PERMISSIONS.view_public_pages,
    PERMISSIONS.manage_own_accompagnements_readonly,
    PERMISSIONS.manage_bookings,
