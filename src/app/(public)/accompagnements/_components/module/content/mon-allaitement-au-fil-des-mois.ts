...
export const MON_ALLAITEMENT_AU_FIL_DES_MOIS: ModuleContent = {
  hero: {
    ...
    titleOverride: "Votre allaitement devient difficile après plusieurs mois ?",
    subtitle:
      "Ce n'est ni un pic de croissance qui s'éternise, ni une fatalité. Passé les premières semaines, on considère que ça roule. Sauf que la baisse de lait, les pics de croissance, les tétées agitées, les dents et le regard des autres arrivent maintenant, et que plus personne ne vous accompagne.",
  ...
  promise: {
    ...
    paragraphs: [
      ...
      "Cet accompagnement reprend, une par une, les questions que les mères me posent entre deux mois et deux ans, avec ce que l'observation clinique permet de répondre.",
    ],
    bullets: [
  ...
  outcomes: {
    ...
    subtitle:
      "Ce que change le fait de savoir lire son allaitement, mois après mois.",
    items: [
  ...
  fit: {
    ...
    subtitle:
      "Pour un allaitement déjà installé, pas pour les tout premiers jours.",
    forYouTitle: "Oui, si",
    forYou: [
    ...
    notForYou: [
      ...
      "Votre question porte sur la reprise du travail, la diversification ou le sevrage : ces trois accompagnements existent séparément.",
  ...
  faq: [
    {
      ...
      a: "Oui. L'accompagnement couvre l'allaitement long, y compris les questions propres au jeune enfant qui tète encore.",
    },
    {
      q: "Je crois que je n'ai plus assez de lait.",
      a: "C'est la crainte la plus fréquente, et rarement fondée. L'accompagnement donne les critères objectifs pour le vérifier avant de conclure, puis les leviers réels si la baisse est confirmée.",
    },
    {
      q: "Mon bébé refuse le sein depuis quelques jours.",
      a: "L'accompagnement traite la grève de la tétée, ses causes possibles et la conduite à tenir. Un refus soudain n'est presque jamais un sevrage.",
    },
  ],
  finalCta: {
