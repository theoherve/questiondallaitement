...
const mockSendAccompagnementAccess = vi.fn();
vi.mock("@/lib/emails/send", () => ({
  sendAccompagnementAccess: (...args: unknown[]) => mockSendAccompagnementAccess(...args),
}));
...
describe("manualEnrollNewClient — validation", () => {
  ...
  it("refuse un accompagnementId invalide", async () => {
