...
import { AdminAccompagnementCreateForm } from "@/app/(dashboard)/admin/accompagnements/_components/accompagnement-create-form";

export const metadata: Metadata = {
  title: "Nouvel accompagnement",
};

const AdminNewAccompagnementPage = async () => {
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-6">
      ...
      <AdminAccompagnementCreateForm consultants={options} />
    </div>
  );
};

export default AdminNewAccompagnementPage;
