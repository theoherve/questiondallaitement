...
import { createAccompagnement } from "../actions";
...
type AdminAccompagnementCreateFormProps = {
...
export const AdminAccompagnementCreateForm = ({
  consultants,
}: AdminAccompagnementCreateFormProps) => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const result = await createAccompagnement(data);
