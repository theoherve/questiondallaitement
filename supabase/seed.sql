...
FROM (
    VALUES (
        ...
        '<h1>Réservation confirmée</h1><p>Bonjour {{client_name}},</p><p>Votre consultation avec {{consultant_name}} est confirmée pour le {{date}} à {{time}}.</p>',
        'transactional',
        '["client_name", "consultant_name", "date", "time"]'
      ),
      (
        'booking_reminder',
