...
| ID   | Tache                                                                 | Statut | Fichiers concernes                     |
| ---- | --------------------------------------------------------------------- | ------ | -------------------------------------- |
| R-22 | Page `/livres` : vitrine des livres publies (couvertures, liens)      | ⬜     | Nouvelle page                          |
| R-23 | Page `/medias` : portfolio medias (TV, podcasts, presse, conferences) | ⬜     | Nouvelle page                          |
| R-24 | Page `/a-propos` : bio editoriale longue de Carole                    | ⬜     | Nouvelle page (ou refonte existante)   |
| R-25 | Renommer route `/formations` → `/accompagnements` (B2C)              | ⬜     | Routing, liens, nav, redirects         |
| R-26 | Adapter `/evenements` → `/formations` (B2B pro)                      | ⬜     | Routing, liens, nav, redirects         |
