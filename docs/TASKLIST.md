...
| **V1.5** | EPIC-15 a EPIC-20 | ⬜ Non commence          |
...
| ID    | Story                                                                                                 | Statut | Prio  |
| ----- | ----------------------------------------------------------------------------------------------------- | ------ | ----- |
| 15-01 | Migration 00017 : enum `blog_status`, tables `blog_categories` + `blog_posts`                         | ⬜      | 🟠 P1 |
| 15-02 | Migration 00017 : RLS policies pour blog (public read published, admin write)                         | ⬜      | 🟠 P1 |
