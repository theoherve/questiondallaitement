 ...
 * « La diversification de mon bébé allaité » (accompagnement_sections.sales_hook).
 *
 ...
 * data/sales-hook-diversification.mjs. Un chapitre sans correspondance est
 * signalé, jamais deviné.
 *
 *   node --env-file=.env.local scripts/apply-sales-hook-diversification.mjs          # dry-run
 *   node --env-file=.env.local scripts/apply-sales-hook-diversification.mjs --apply
 */

import { createClient } from "@supabase/supabase-js";
import { SALES_HOOKS_DIVERSIFICATION } from "./data/sales-hook-diversification.mjs";

const APPLY = process.argv.includes("--apply");
const SLUG = "la-diversification-de-mon-bebe-allaite";
...
for (const entry of SALES_HOOKS_DIVERSIFICATION) {
...
console.log(`Correspondances trouvées : ${matched.length}/${SALES_HOOKS_DIVERSIFICATION.length}\n`);
