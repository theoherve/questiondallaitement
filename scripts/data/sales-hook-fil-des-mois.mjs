...
export const SALES_HOOKS_FIL_DES_MOIS = [
  ...
  {
    searchTitles: ["Je suis inquiète pour mon allaitement"],
  ...
  {
    searchTitles: ["Mon bébé est agité"],
    newTitle: "Aléas et maux du quotidien : gaz, reflux, selles, bronchiolite",
    hook: "Vous saurez quand un désagrément est bénin et quand il faut consulter, pour chaque symptôme courant de votre bébé.",
  },
  {
    searchTitles: ["Je suis inquiète pour mon bébé"],
